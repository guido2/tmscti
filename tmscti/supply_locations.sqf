...
tms_sl_saltlake_beachhead = ["Salt Lake Beachhead", // Display name of the location
	...
	2, // Tier
	["salt_lake_beachhead", "salt_lake_beachhead_lc_pos", false, "salt_lake_beachhead_sl_pos", "salt_lake_beachhead_heli_pos"], // Positions for actual delivery, in order: Self delivery for amphibious vehicles, Delivery via landing craft, delivery via ship, Delivery via helicopter slingload, Self-delivery of helicopters, false where not possible at this location
...
tms_sl_saltlake_airfield = ["Almyra Salt Lake Airstrip",
	"salt_lake_airfield", 
	3, 
	[false, false, false, "salt_lake_airfield_sl_pos", "salt_lake_airfield_heli_pos"],
	5,
	independent, 
	[500, 500], 
	"airport" 
...
tms_sl_airbase_airfield = ["Altis Airbase",
	"airbase_airfield", 
	3, 
	[false, false, false, "airbase_airfield_sl_pos", "airbase_airfield_heli_pos"],
	0,
	independent, 
	[500, 500], 
	"airport" 
...
tms_sl_aac_airfield = ["AAC Airfield",
	"aac_airfield", 
	2, 
	[false, false, false, "aac_airfield_sl_pos", "aac_airfield_heli_pos"],
	1,
	independent, 
	[500, 500], 
	"airfield2" 
...
tms_sl_molos_airfield = ["Molos Airfield",
	"molos_airfield", 
	2, 
	[false, false, false, "molos_airfield_sl_pos", "molos_airfield_heli_pos"],
	4,
	independent, 
	[500, 500], 
	"airfield2" 
...
tms_sl_krya_nera_airstrip = ["Krya Nera Airstrip",
	"krya_nera_airfield", 
	1, 
	[false, false, false, "krya_nera_airfield_sl_pos", "krya_nera_airfield_heli_pos"],
	2,
	independent, 
	[500, 500], 
	"airfield1" 
...
tms_sl_selakano_airfield = ["Selakano Airfield",
	"selakano_airfield", 
	1, 
	[false, false, false, "selakano_airfield_sl_pos", "selakano_airfield_heli_pos"],
	3,
	independent, 
	[500, 500], 
	"airfield1" 
...
tms_sl_military_hill_outpost = ["Military Hill Outpost",
	...
	1, 
	[false, false, false, "military_hill_helipad_sl_pos", "military_hill_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad1" 
...
tms_sl_telos_military_outpost = ["Telos Military Outpost",
	...
	2, 
	[false, false, false, "telos_military_outpost_helipad_sl_pos", "telos_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport2" 
...
tms_sl_altis_military_base = ["Altis Military Base",
	...
	3, 
	[false, false, false, "altis_military_base_helipad_sl_pos", "altis_military_base_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport3" 
...
tms_sl_pefkas_military_outpost = ["Pefkas Military Outpost",
	...
	2, 
	[false, false, false, "pefkas_military_outpost_helipad_sl_pos", "pefkas_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad2" 
...
tms_sl_agios_georgios_military_outpost = ["Agios Georgios Military Outpost",
	...
	3, 
	[false, false, false, "agios_georgios_military_outpost_helipad_sl_pos", "agios_georgios_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport3" 
...
tms_sl_pyrgos_military_base = ["Pyrgos Military Base",
	...
	3, 
	[false, false, false, "pyrgos_military_base_helipad_sl_pos", "pyrgos_military_base_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad3" 
...
tms_sl_fort_vikos = ["Fort Vikos",
	"fort_vikos_helipad", 
	1, 
	[false, false, false, "pyrgos_military_base_helipad_sl_pos", false],
	false,
	independent, 
	[500, 500], 
	"cargoport1" 
...
tms_sl_vikos_military_outpost = ["Vikos Military Outpost",
	...
	1, 
	[false, false, false, "vikos_military_outpost_helipad_sl_pos", "vikos_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad1" 
...
tms_sl_zaros_military_outpost = ["Zaros Military Outpost",
	...
	1, 
	[false, false, false, "zaros_military_outpost_helipad_sl_pos", "zaros_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport1" 
...
tms_sl_altis_cargo_harbor = ["Altis Cargo Harbor",
	...
	3, 
	[false, false, "altis_cargo_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor3" 
...
tms_sl_anthrakia_docks = ["Anthrakia Docks",
	...
	1, 
	[false, false, "anthrakia_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_sideras_docks = ["Sideras Docks",
	...
	2, 
	[false, false, "sideras_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_iraklia_docks = ["Iraklia Docks",
	...
	1, 
	[false, false, "iraklia_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_pefkas_docks = ["Pefkas Docks",
	"pefkas_docks_harbor", 
	1, 
	[false, false, "pefkas_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_agios_georgios_docks = ["Agios Georgios Docks",
	...
	2, 
	[false, false, "agios_georgios_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_kalithea_harbor = ["Kalithea Harbor",
	...
	2, 
	[false, false, "kalithea_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_cap_zefyris_docks = ["Cap Zefyris Docks",
	...
	2, 
	[false, false, "zefyris_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_agia_triada_docks = ["Agia Triada Docks",
	...
	1, 
	[false, false, "agia_triada_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_nychi_docks = ["Nychi Docks",
	"nychi_docks_harbor", 
	1, 
	[false, false, "nychi_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_pyrgos_cargo_harbor = ["Pyrgos Cargo Harbor",
	...
	3, 
	[false, false, "pyrgos_cargo_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor3" 
...
tms_sl_mazi_docks = ["Mazi Docks",
	"mazi_docks_harbor", 
	2, 
	[false, false, "mazi_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_trachia_docks = ["Trachia Docks",
	...
	1, 
	[false, false, "trachia_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_aktinarki_docks = ["Aktinarki Docks",
	...
	1, 
	[false, false, "aktinarki_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_cap_kategidis_docks = ["Cap Kategidis Docks",
	...
	1, 
	[false, false, "cap_kategidis_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_polemistia_docks = ["Polemistia Docks",
	...
	1, 
	[false, false, "polemistia_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_molos_harbor = ["Molos Harbor",
	"molos_harbor_harbor", 
	2, 
	[false, false, "molos_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_sagonisi_docks = ["Sagonisi Docks",
	...
	2, 
	[false, false, "sagonisi_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_katalaki_docks = ["Katalaki Docks",
	...
	1, 
	[false, false, "katalaki_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_neochori_harbor = ["Neochori Harbor",
	...
	2, 
	[false, false, "neochori_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor2" 
...
tms_sl_stavros_docks = ["Stavros Docks",
	...
	1, 
	[false, false, "stavros_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_lakka_military_outpost = ["Lakka Military Outpost",
	...
	2, 
	[false, false, false, "lakka_military_outpost_helipad_sl_pos", "lakka_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport2" 
...
tms_sl_aggelochori_docks = ["Aggelochori Docks",
	...
	1, 
	[false, false, "aggelochori_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_kavala_harbor = ["Kavala Harbor",
	...
	3, 
	[false, false, "kavala_harbor_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor3" 
...
tms_sl_kavala_pier = ["Kavala Pier",
	"kavala_pier_harbor", 
	3, 
	[false, false, "kavala_pier_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor3" 
...
tms_sl_athanos_docks = ["Athanos Docks",
	...
	1, 
	[false, false, "athanos_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_iremi_docks = ["Iremi Docks",
	"iremi_docks_harbor", 
	1, 
	[false, false, "iremi_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_zaros_docks = ["Zaros Docks",
	"zaros_docks_harbor", 
	1, 
	[false, false, "zaros_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_therisa_docks = ["Therisa Docks",
	...
	1, 
	[false, false, "therisa_docks_dock", false, false],
	false,
	independent, 
	[500, 500], 
	"harbor1" 
...
tms_sl_athira_military_outpost = ["Athira Military Outpost",
	...
	1, 
	[false, false, false, "athira_military_outpost_helipad_sl_pos", "athira_military_outpost_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad1" 
...
tms_sl_faronaki_beachhead = ["Faronaki Beachhead",
	"faronaki_beachhead",
	2,
	["faronaki_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead2"
...
tms_sl_ekali_beachhead = ["Ekali Beachhead",
	"ekali_beachhead",
	3,
	["ekali_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
...
tms_sl_selakano_beachhead = ["Selakano Beachhead",
	"selakano_beachhead",
	3,
	["selakano_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
...
tms_sl_delfinaki_beachhead = ["Delfinaki Beachhead",
	"delfinaki_beachhead",
	2,
	["delfinaki_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead2"
...
tms_sl_ammolofi_beachhead = ["Ammolofi Beachhead",
	"ammolofi_beachhead",
	3,
	["ammolofi_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
...
tms_sl_stadium_landing_zone = ["Stadium Landing Zone",
	...
	3, 
	[false, false, false, "stadium_landing_zone_helipad_sl_pos", "stadium_landing_zone_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"helipad3" 
...
tms_sl_xirolimni_landing_zone = ["Xirolimni Landing Zone",
	...
	2, 
	[false, false, false, "xirolimni_landing_zone_helipad_sl_pos", "xirolimni_landing_zone_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport2" 
...
tms_sl_hill215_landing_zone = ["Hill 215 Landing Zone",
	...
	3, 
	[false, false, false, "hill215_landing_zone_helipad_sl_pos", "hill215_landing_zone_helipad_heli_pos"],
	false,
	independent, 
	[500, 500], 
	"cargoport3" 
...
tms_sl_oreokastro_beachhead = ["Oreokastro Beachhead",
	...
	2,
	["oreokastro_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead2"
...
tms_sl_fotia_beachhead = ["Fotia Beachhead",
	"fotia_beachhead",
	2, 
	["fotia_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead2"
...
tms_sl_agios_konstantions_beachhead = ["Agios Konstantinos Beachhead",
	...
	3,
	["agios_konstantinos_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
...
tms_sl_fournos_beachhead = ["Fournos Beachhead",
	"fournos_beachhead",
	1,
	["fournos_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead1"
...
tms_sl_athanos_beachhead = ["Athanos Beachhead",
	"athanos_beachhead",
	2,
	["athanos_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead2"
...
tms_sl_panochori_beachhead = ["Panochori Beachhead",
	"panochori_beachhead",
	3,
	["panochori_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
...
tms_sl_edessa_beachhead = ["Edessa Beachhead",
	"edessa_beachhead",
	3,
	["edessa_beachhead", false, false, false, false],
	false,
	independent,
	[500, 500],
	"beachhead3"
