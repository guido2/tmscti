...
if (tms_master_gear_box canAdd _robjects_class_name) then {	
	tms_master_gear_box additemCargo [_robjects_class_name, 1] ;
...
if (tms_master_gear_box canAdd _bipodobjects_class_name) then {	
	tms_master_gear_box additemCargo [_bipodobjects_class_name, 1] ;
...
if (tms_master_gear_box canAdd _silencerobjects_class_name) then {	
	tms_master_gear_box additemCargo [_silencerobjects_class_name, 1] ;
...
if (tms_master_gear_box canAdd _magazineobjects_class_name) then {	
	tms_master_gear_box additemCargo [_magazineobjects_class_name, 1] ;
