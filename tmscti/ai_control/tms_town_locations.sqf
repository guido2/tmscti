...
_tms_tl_ioannina setTriggerStatements ["{isPlayer _x} count thisList > 0", "[[ThisTrigger], 'tmscti\ai_control\tms_ai_spawn_and_equip.sqf'] remoteExec ['execVM', 2, false];", ""];
...
_tms_tl_altismilitarybase setTriggerStatements ["{isPlayer _x} count thisList > 0", "[[ThisTrigger], 'tmscti\ai_control\tms_ai_spawn_and_equip.sqf'] remoteExec ['execVM', 2, false];", ""];
