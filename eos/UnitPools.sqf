...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["I_engineer_F","I_Soldier_A_F","I_Soldier_AA_F","I_Soldier_AAA_F","I_Soldier_AAR_F","I_Soldier_AAT_F","I_Soldier_AR_F","I_Soldier_AT_F","I_Soldier_exp_F","I_soldier_F","I_Soldier_GL_F","I_Soldier_repair_F"];	
	_ArmPool=	["B_G_Offroad_01_armed_F","CUP_O_Datsun_PK"];
	_MotPool=	["B_G_Offroad_01_F","B_G_Van_01_transport_F","RHS_Ural_Open_Civ_01"];
	_ACHPool=	[];
	_CHPool=	["C_Heli_Light_01_civil_F"];
	_uavPool=	[];
	_stPool=	[];
	_shipPool=	["B_Lifeboat"];
	_diverPool=	[];
	_crewPool=	["I_Soldier_A_F"];
	_heliCrew=	["I_Soldier_A_F"];
	};
